...
system("title " + "Sessionid Grabber - Coded By Mb")
...
# Inc. Password
    def login2(): 
        ...
        if login2.content == b'{"user": false, "authenticated": false, "status": "ok"}': 
            ...
            print(f"[{Fore.GREEN}+{Fore.RESET}] Session Saved Successfully ["+ username + ".txt]") 
            open(username + ".txt", "a+").write("@" + username + "\nSession ID: " + sessionid)
            defwait = input(f"[{Fore.MAGENTA}!{Fore.RESET}] Press Any Key... ") 
